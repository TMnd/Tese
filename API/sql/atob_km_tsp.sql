-- Function: public.pgr_deaparabkmtsp(text, integer[])

-- DROP FUNCTION public.pgr_deaparabkmtsp(text, integer[]);

CREATE OR REPLACE FUNCTION public.pgr_deaparabkmtsp(
    IN tbl text,
    IN pois integer[],
    OUT seq integer,
    OUT gid integer,
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION public.pgr_deaparabkmtsp(text, integer[])
  OWNER TO amaral;