...
GitRepository: https://github.com/Jorl17/open-elevation
Owner: João Ricardo Lourenço
Nota: Codigo open-source que foi incorporado nesta API para evitar a necessidade de correr um segundo
processo na maquina e porque o serviço publico encontra-se batante limitado em termos de chamamentos
por segundos.
"""
